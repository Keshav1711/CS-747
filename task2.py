...
HORIZON = 30000
P1 = 0.9
P2_values = np.arange(0, 0.901, 0.05) 
P2=0
# END EDITING HERE
...
def simulate_task2(algorithm, P1, P2_values, horizon, num_sims=50):
  ...
  #     sim_out = pool.starmap(single_sim_task2, [(i, algorithm, P1, P2_values, horizon) for i in range(num_sims)])
  #   return sim_out 
...
if __name__ == '__main__':
  ...
  algorithm = UCB  # Change this to the desired algorithm
  regrets = simulate_task2(algorithm, P1, P2_values, HORIZON)
  print(regrets)
  # Plot the results
  plt.figure(figsize=(8, 6))
  plt.plot(P2_values, regrets, marker='o', linestyle='-', color='b')
